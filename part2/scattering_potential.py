...
# This means that energies are expressed in units 1 / Re **2
#
...
# m an Re, and express the quantity 2 * m / hbar ** 2 in terms of eV and Re as
# 2 * m / hbar ** 2 = Scaling * 1 / (eV * Re ** 2)
# Physical energies can then be used as input by assigning this value to the variable Scaling
# A different unit of length can also be used, simply by express Re and Scaling in terms of this unit
#
#
